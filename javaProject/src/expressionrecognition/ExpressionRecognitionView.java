...
public class ExpressionRecognitionView extends FrameView {
    public ExpressionRecognitionView(SingleFrameApplication app) {
        ...
        try {
            int r = FSDK.ActivateLibrary("P03iJHEqc//2kHN3615ojSoqm3rB5RDSVxDtrt7SWR+tp9U+BXLOHh17HueMAke+56BKFSmBkrWIg6yOBOoI7onF5/dOvVVKoCVUadr2i/uUhJ3H/GACW1e4kKU5OH5KfO69qaDfXiaV/sHL6x20iENn9OqbOMGe26o1UvroHB8=");
            if (r != FSDK.FSDKE_OK){
